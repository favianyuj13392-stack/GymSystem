    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-zinc-900 border border-zinc-800 rounded-[2rem] shadow-2xl w-full max-w-sm overflow-hidden transform transition-all animate-in zoom-in-95 duration-200 p-6 text-slate-100">
        <div className="text-center">
          ...
          <h3 className="text-xl font-bold text-white mb-2">Eliminar Empleado</h3>
          <p className="text-sm text-zinc-400 mb-6">
            ¿Estás seguro de eliminar a <strong>{empleado.nombre} {empleado.apellido}</strong> ({empleado.email})? Esta acción revocará inmediatamente sus accesos.
          </p>
        </div>
